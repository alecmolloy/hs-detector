  ...
  React.useEffect(() => {
    ;(async () => {
      ...
      if (videoSrcObject == null) {
        ...
        const source = await window.navigator.mediaDevices
          .getUserMedia({
            video: true,
          })
          .catch(() => {
 ...
 * - is the Offscreen Canvas API a way to multi-thread this?
 * - find a way to make loading not be block the main thread, or cache things: https://create-react-app.dev/docs/making-a-progressive-web-app/#why-opt-in
 */
